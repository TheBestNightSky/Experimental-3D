...
public:
	...
	void CreateBuffer(Graphics& gfx, DirectX::FXMMATRIX view, std::vector<PointLightData>) const noexcept;
	void Submit(class FrameCommander& frame) const noxnd;
	void Bind(Graphics& gfx, DirectX::FXMMATRIX view) const noexcept;
	unsigned int GetBufferBindCount() noexcept;
private:
...
private:
	...
	static std::unique_ptr<Bind::CachingPixelConstantBufferEx> pViewBuffer;
